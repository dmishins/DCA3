...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.chk_super.setGeometry(QtCore.QRect(190, 170, 141, 21))
    ...
    def plot(self):
        ...
        print "python takeandexportroot.py -lf " + str(self.binfilename.text()) + " -p " + ch + super + fft + ahist + hist + " --ignore_timestamp"

        os.system("python takeandexportroot.py -lf " + str(self.binfilename.text()) + " -p " + ch + super + fft + ahist + hist + " --ignore_timestamp")
